...
Приложение обеспечивает удобный доступ к данным, повышая эффективность учета мероприятий и взаимодействия с клиентами.
 ...
 4. Система сбора и обработки исторических метеоданных

Проект представляет собой приложение для автоматизированного сбора архивных метеоданных по выбранным метеостанциям за заданный период. Реализованы парсинг HTML-страниц, сохранение 

результатов в CSV, обновление уже собранных данных, контроль пропусков и дубликатов, а также графический интерфейс для разового и автоматического запуска задач по расписанию.

Технологии: Python, pandas, requests, BeautifulSoup, customtkinter, JSON, многопоточность.
